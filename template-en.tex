...
\title{B.Sc. in Computer Engineering}
...
\usepackage{multibib}
\newcites{book,misc}{{Books},{Papers}}
%----------------------------------------------------------------------------------
%            contenido
%----------------------------------------------------------------------------------
\begin{document}
...
\section{Education}
\cventry{2016--}{M.Sc. in Computer Engineering}{Universidad de Granada}{Granada}{}{} 
\cventry{2012--2016}{B.Sc. in Computer Engineering}{Universidad de Granada}{Granada}{\textit{8.378}}{Special mention in Software Engineering. I was graded with honours in 9 courses, including the End-of-Degree Project.}
\cventry{2010--2012}{High School}{Juan XXIII - Chana}{Granada}{\textit{With Honours}}{Science and Technology. Best academic results of the year.}

\section{Experience}
\cventry{2016--}{Scholarship Assistant}{Department of Lenguajes y Sistemas Informáticos}{Granada}{}{
...
\section{Knowledge}
\cvitem{Web development}{Symfony, Flask, Django, Bootstrap}
\cvitem{Database}{MongoDB, MySQL, OracleSQL}
\cvitem{Mobile applications}{Android}
\cvitem{Computer Graphics}{OpenGL, WebGL, Blender, Java3D, Three.js, X3D, VTK, ITK}
